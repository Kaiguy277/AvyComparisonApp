...
// dispatch into the headless JS runtime when the OS wakes the app for a
// BG fetch or a silent push delivery. registerIfPermitted runs every
// launch in no-prompt mode; the in-app onboarding modal is what triggers
